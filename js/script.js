...
function setFavicon(emoji){
    ...
    let svgUrl = `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 110"><text x="50%" y="55%" style="dominant-baseline:middle;text-anchor:middle;font-size:90px;">${emoji}</text></svg>`
